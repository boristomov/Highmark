                                ...
                                <Grid className="chCardBody">
                                    <Collapse in={tabs.payment} timeout="auto">
                                        ...
                                        <Collapse in={forms.payment_method === 'card'} timeout="auto">
                                            <Grid className="cardType">
                                                <Link href='/order-received' type="submit" className="theme-btn-s3 cBtn cBtnLarge cBtnTheme mt-20">Proceed to Checkout</Link>
                                            </Grid>
                                        </Collapse>
                                    </Collapse>
                                </Grid>
                                                ...
                                                {(() => {
                                                    ...
                                                    return (
                                                        <Fragment>
                                                            ...
                                                            <TableRow>
                                                                <TableCell>Tax (7.25%)</TableCell>
                                                                <TableCell align="right">${taxAmount}</TableCell>
                                                            </TableRow>
                                                            <TableRow>
                                                                <TableCell>Delivery</TableCell>
                                                                <TableCell align="right">TBD - available in return email upon sending a quote request</TableCell>
                                                            </TableRow>
                                                            <TableRow>
